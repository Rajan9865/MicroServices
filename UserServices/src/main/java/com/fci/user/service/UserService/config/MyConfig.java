...
public class MyConfig {
	...
	public RestTemplate restTemplate() {
		...
		clientHttpRequestInterceptors.add(new RestTemplateInterceptor(
				auth2AuthorizedClientManager(clientRegistrationRepository, oAuth2AuthorizedClientRepository)));
